...
Web page created to provide use instructions and present consent form to 'Interactive lounge' experiment participants.

## Credits

Webpages created by Sara Maia using 'Start Bootstrap' template.
